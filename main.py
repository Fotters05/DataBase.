...
if __name__ == "__main__":
    ...
    iphone_x = Tovar(None, "iPhone X", 29999.99, 5)
    iphone_11 = Tovar(None, "iPhone 11", 34999.99, 10)
    iphone_12 = Tovar(None, "iPhone 12", 55999.99, 20)
    iphone_13 = Tovar(None, "iPhone 13", 79999.99, 30)
    iphone_14 = Tovar(None, "iPhone 14", 90000, 25)

    Database.add_tovar(iphone_x)
    Database.add_tovar(iphone_11)
    Database.add_tovar(iphone_12)
    Database.add_tovar(iphone_13)
    Database.add_tovar(iphone_14)
